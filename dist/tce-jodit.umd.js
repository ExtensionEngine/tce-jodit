(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jodit-vue'), require('auto-bind'), require('cuid'), require('brace'), require('js-beautify/js/src/html'), require('brace/mode/html'), require('brace/theme/chrome'), require('scrollparent')) :
  typeof define === 'function' && define.amd ? define(['exports', 'jodit-vue', 'auto-bind', 'cuid', 'brace', 'js-beautify/js/src/html', 'brace/mode/html', 'brace/theme/chrome', 'scrollparent'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__TAILOR_CONTENT_ELEMENTS__ = global.__TAILOR_CONTENT_ELEMENTS__ || {}, global.__TAILOR_CONTENT_ELEMENTS__['@extensionengine/tce-jodit'] = {}), global.joditVue, global.autoBind, global.cuid, global.ace, global.beautify, null, null, global.scrollparent));
}(this, (function (exports, joditVue, autoBind, cuid, ace, beautify, html, chrome, scrollparent) { 'use strict';
  ...
  if ((_DataView && getTag(new _DataView(new ArrayBuffer(1))) != dataViewTag$3) ||
      ...
      (_Set$1 && getTag(new _Set$1) != setTag$5) ||
    ...
    getActiveEntry(jodit, control, defaultValue) {
      ...
      if (control.name === JODIT_CONTROL_FONT) {
        ...
        return find(entries, ([fontFamily]) => {
          return normalize$1.fontFamily(fontFamily) === currentFontFamily;
        }, [null, defaultValue]);
      }
      ...
      if (control.name === JODIT_CONTROL_FONTSIZE) {
        ...
        return find(entries, ([_, fontSize]) => {
          return fontSize === normalize$1.fontSize(currentFontSize);
        }, [null, defaultValue]);
      }
  ...
  class MdiIconsPlugin {
    ...
    */
    ...
    colorPopup(popup, jodit, current, control, close = noop$1) {
      const {
        events,
        options
      } = jodit;
  ...
  var script = {
    ...
    methods: {
      save(files = []) {
        if (!this.hasChanges && isEmpty_1(files)) return;
        const {
          element,
          content
        } = this;
